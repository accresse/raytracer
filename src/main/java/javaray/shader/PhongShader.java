...
public class PhongShader extends ObjectShader {
  ...
  protected Material m=Material.DEFAULT;

  public PhongShader(){}
  public PhongShader(Material m){this.m=m;}

  public void setMaterial(Material m){this.m=m;}
  ...
  public Color getColor(Ray ray, Point3d position, Scene scene, Tracer tracer, SceneObject obj) {
      ...
      Color Kd=curr_material.getReflDiff(); //diffuse multiplier
